...
public class GameInfo implements PropertyChangeListener {
    ...
    public void init() {
        ...
        this.pillDuration = 0;
        this.tofuDuration = 0;
        this.ghostEatenBonus = Constants.GAME_INFO_GHOST_EATEN_INITIAL_BONUS;
        this.scores = 0;
        this.level = 1;
        this.status = 0;
        this.leftDots = Constants.GAME_INFO_TOTAL_DOTS;
        this.fruitDisappearTime = Constants.GAME_INFO_RANDOM_CHERRY_PERIOD;
        this.mode = Constants.PILL_MODE;
