...
import edu.rice.comp504.model.ghoststrategy.ChaseBehaviour;
import edu.rice.comp504.model.ghoststrategy.DeathBehaviour;
import edu.rice.comp504.model.ghoststrategy.FrightenedBehaviour;
import edu.rice.comp504.model.ghoststrategy.ScatterBehaviour;
        ...
        if (pacMan.isVisible()) {
            ...
            if (gameInfo.getTofuDuration() <= 0) {
                for (PropertyChangeListener ghost : ghosts) {
                    resetGhostBehavior((Ghost) ghost, pacMan);
                }
